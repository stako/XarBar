		...
		general = {
			...
			args = {
				auraIconSize = {
					...
					max = 52,
					step = 1,
					get = function() return XarBar.db.profile.auraIconSize end,
					set = function(info, val) XarBar.db.profile.auraIconSize = val; UpdateAuras(); end,
				},
				maxRowSize = {
					...
					max = 16,
					step = 1,
					get = function() return XarBar.db.profile.maxRowSize end,
					set = function(info, val) XarBar.db.profile.maxRowSize = val; UpdateAuras(); end,
				},
				maxGroup = {
					name = "Max # of icons",
					type = "group",
					...
					args = {
						maxBuffs = {
							...
							max = 32,
							step = 1,
							get = function() return XarBar.db.profile.maxBuffs end,
							set = function(info, val) XarBar.db.profile.maxBuffs = val; UpdateAuras(); end,
						},
						maxDebuffs = {
							name = "Debuffs",
							...
							max = 32,
							step = 1,
							get = function() return XarBar.db.profile.maxDebuffs end,
							set = function(info, val) XarBar.db.profile.maxDebuffs = val; UpdateAuras(); end,
						},
					},
				},
				spacingGroup = {
					...
					args = {
						auraSpacingX = {
							...
							max = 32,
							step = 1,
							get = function() return XarBar.db.profile.auraSpacingX end,
							set = function(info, val) XarBar.db.profile.auraSpacingX = val; UpdateAuras(); end,
						},
						auraSpacingY = {
							name = "Vertical",
							...
							max = 32,
							step = 1,
							get = function() return XarBar.db.profile.auraSpacingY end,
							set = function(info, val) XarBar.db.profile.auraSpacingY = val; UpdateAuras(); end,
						},
					},
				},
				positioningGroup = {
					...
					args = {
						auraStartX = {
							...
							max = 600,
							step = 1,
							get = function() return XarBar.db.profile.auraStartX end,
							set = function(info, val) XarBar.db.profile.auraStartX = val; UpdateAuras(); end,
						},
						auraStartY = {
							name = "Y Offset",
							type = "range",
							...
							max = 600,
							step = 1,
							get = function() return XarBar.db.profile.auraStartY end,
							set = function(info, val) XarBar.db.profile.auraStartY = val; UpdateAuras(); end,
						},
					},
				},
				petPositioningGroup = {
					...
					args = {
						auraPetStartX = {
							...
							max = 600,
							step = 1,
							get = function() return XarBar.db.profile.auraPetStartX end,
							set = function(info, val) XarBar.db.profile.auraPetStartX = val; UpdateAuras(); end,
						},
						auraPetStartY = {
							name = "Y Offset",
							type = "range",
							...
							max = 600,
							step = 1,
							get = function() return XarBar.db.profile.auraPetStartY end,
							set = function(info, val) XarBar.db.profile.auraPetStartY = val; UpdateAuras(); end,
						},
					},
				},
				showAuraCount = {
					...
					order = 7,
					width = "normal",
					get = function() return XarBar.db.profile.showAuraCount end,
					set = function(info, val) XarBar.db.profile.showAuraCount = val; UpdateAuras(); end,
				},
				buffsOnTop = {
					name = "Buffs on Top",
					...
					order = 8,
					width = "normal",
					get = function() return XarBar.db.profile.buffsOnTop end,
					set = function(info, val) XarBar.db.profile.buffsOnTop = val; UpdateAuras(); end,
				},
			},
		},
